# training.py`: código para entrenar y guardar el modelo entrenado con el input de los datos de la carpeta `data/processed`
#  y guardar los datasets de `data/train` y `data/test` utilizados en el entrenamiento.
...
with open('../models/gbc_roc_auc271123.pkl', "wb") as archivo_salida:
